        ...
        for i, line in enumerate(lines):
            if i % 2 == 0:
                ...
                if i + 1 < len(lines):
                    ...
                    sentences.append(source + self.data_sep + target)
                    if include_reverse:
                        reverse_sentences.append(target + self.data_sep + source)
...
if __name__ == "__main__":
    ...
    un.save_data(save_path=Path("data/cleaned_data/aadf.csv"))
